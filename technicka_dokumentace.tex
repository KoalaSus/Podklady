...
\begin{table}[h]
    ...
    \begin{tabular}{|l|l|}
        ...
        Odhadované náklady & $\approx$ 4\,500 -- 5\,000~Kč \\ \hline
    \end{tabular}
    \caption{Základní technická specifikace skeneru}
\end{table}

\section{Konstrukční cíle}
Důraz je kladen na uzavřené provedení konstrukce, které eliminuje externí světelný šum \mbox{a zajišťuje} mechanickou stabilitu všech měřicích komponent vůči ose rotace.
...
Následující tabulky specifikují propojení jednotlivých prvků s~řídicí jednotkou \mbox{Raspberry Pi 5} a externím napájením.
...
Obsluha displeje je integrována přímo v rámci služby \texttt{skener.service}. Systémem je periodicky kontrolován aktuální stav (\textit{State API}) a vypisováno odpovídající hlášení (např. probíhající sken). Toto řešení zajišťuje základní zpětnou vazbu i v případě výpadku síťového spojení s klientským zařízením.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.75\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/web_dashboard.png}
        \caption{Hlavní ovládací panel v průběhu skenování}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.75\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/web_skeny.png}
        \caption{Záložka „Skeny“ se seznamem hotových modelů a 3D náhledem}
    \end{subfigure}
    
    \caption{Uživatelské rozhraní systému (Dashboard)}
    \label{fig:web_rozhrani}
\end{figure}
...
\bibitem{xiao2019laser}
XIAO, Michael a SCAVELLA, Thomas. \textit{Laser 3D Scanner}. Online. ECE 5725: \mbox{Embedded} OS. 14. května 2019. Dostupné z: \url{https://courses.ece.cornell.edu/ece5990/ECE5725_Spring2019_Projects/3D_Scanner_mfx2_tbs47/index.html}. [cit. 2026-05-11].
\end{thebibliography}
