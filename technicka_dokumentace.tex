...
\begin{itemize}
    ...
    \item \textbf{Nginx:} Vysoce výkonný webový server, který slouží jako reverzní proxy pro webové rozhraní skeneru. Zajišťuje plynulý přístup k ovládacímu panelu přes prohlížeč.
